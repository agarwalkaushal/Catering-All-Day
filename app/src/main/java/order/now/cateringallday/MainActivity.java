        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(MainActivity.this, openlogin.class));
                    finish();
                }
            }
        };
...
public void navigateToBaseActivity(View view) {
    ...
    merchantKey="gtkFFx";
    String amount="10";
    String email="kaushalagarwal79@gmail.com";
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, PayuHashes> {
        ...
        protected PayuHashes doInBackground(String... postParams) {
            ...
            try {
                ...
                URL url = new URL("https://mobiletest.payu.in/merchant/postservice?form=2");
